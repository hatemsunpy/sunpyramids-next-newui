...
export default async function Page() {
  ...
  return (
    <SiteShell locale="en" settings={settings}>
      ...
      <HomePage page={page} tours={tours} popularTours={popularTours} specialOffers={specialOffers} highlights={highlights} blogs={blogs} faqs={faqs} events={events} socialLinks={settings.socialLinks} locale="en" />
    </SiteShell>
  );
}
